function Footer() {
  return (
    <footer className="px-4 divide-y bg-[#1A1919] text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 max-w-5xl">
      ...
      <div className="py-6 text-sm text-center text-gray-400">
        © 2024 Career Hub Co. All rights reserved.
      </div>
    </footer>
  );
}
